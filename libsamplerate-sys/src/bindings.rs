...
// manual changes:
// - type converter_type = c_int instead of _bindgen_ty_1 = c_uint
...
fn bindgen_test_layout_SRC_DATA() {
    ...
    assert_eq!(
        unsafe { &(*(0 as *const SRC_DATA)).data_in as *const _ as usize },
        0usize,
        concat!(
            "Alignment of field: ",
            stringify!(SRC_DATA),
    ...
    assert_eq!(
        unsafe { &(*(0 as *const SRC_DATA)).data_out as *const _ as usize },
        8usize,
        concat!(
            "Alignment of field: ",
            stringify!(SRC_DATA),
    ...
    assert_eq!(
        unsafe { &(*(0 as *const SRC_DATA)).input_frames as *const _ as usize },
        16usize,
        concat!(
            "Alignment of field: ",
            stringify!(SRC_DATA),
    ...
    assert_eq!(
        unsafe { &(*(0 as *const SRC_DATA)).output_frames as *const _ as usize },
        24usize,
        concat!(
            "Alignment of field: ",
            stringify!(SRC_DATA),
    ...
    assert_eq!(
        unsafe { &(*(0 as *const SRC_DATA)).input_frames_used as *const _ as usize },
        32usize,
        concat!(
            "Alignment of field: ",
            stringify!(SRC_DATA),
    ...
    assert_eq!(
        unsafe { &(*(0 as *const SRC_DATA)).output_frames_gen as *const _ as usize },
        40usize,
        concat!(
            "Alignment of field: ",
            stringify!(SRC_DATA),
    ...
    assert_eq!(
        unsafe { &(*(0 as *const SRC_DATA)).end_of_input as *const _ as usize },
        48usize,
        concat!(
            "Alignment of field: ",
            stringify!(SRC_DATA),
    ...
    assert_eq!(
        unsafe { &(*(0 as *const SRC_DATA)).src_ratio as *const _ as usize },
        56usize,
        concat!(
            "Alignment of field: ",
            stringify!(SRC_DATA),
...
pub type src_callback_t = ::std::option::Option<
    unsafe extern "C" fn(cb_data: *mut ::std::os::raw::c_void, data: *mut *mut f32)
        -> ::std::os::raw::c_long,
>;
extern "C" {
    pub fn src_new(
...
pub const SRC_SINC_BEST_QUALITY: converter_type = 0;
pub const SRC_SINC_MEDIUM_QUALITY: converter_type = 1;
pub const SRC_SINC_FASTEST: converter_type = 2;
pub const SRC_ZERO_ORDER_HOLD: converter_type = 3;
pub const SRC_LINEAR: converter_type = 4;
pub type converter_type = ::std::os::raw::c_int;
extern "C" {
